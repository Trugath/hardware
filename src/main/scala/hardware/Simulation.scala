...
abstract class Simulation {
  ...
  // delay lower bounds
  private val GateDelay = 1000

  // add a small amount of variance
  private val random: Random = new Random()
  private def getGateVariance: Int = random.nextInt(10)
  ...
  def logicDiode(input: Wire, output: Wire) {
    val gateVariance = getGateVariance
    def passAction() {
      val inputSig = input.getSignal
      afterDelay(GateDelay + gateVariance) { output setSignal inputSig }
    }
    input addAction passAction
  }

  def nAndGate(a1: Wire, a2: Wire, a3: Wire, output: Wire): Unit = {
    val gateVariance = getGateVariance
    def andAction() {
      val a1Sig = a1.getSignal
      val a2Sig = a2.getSignal
      val a3Sig = a3.getSignal
      afterDelay(GateDelay + gateVariance) { output setSignal !(a1Sig & a2Sig & a3Sig) }
    }
  ...
  def nAndGate(a1: Wire, a2: Wire, output: Wire): Unit = nAndGate(a1, a2, Wire.trueWire, output)

  def inverter(input: Wire, output: Wire): Unit = nAndGate(input, input, output)
  ...
  def andGate(a1: Wire, a2: Wire, a3: Wire, output: Wire): Unit = {
    val i1: Wire = new Wire
    andGate(a1, a2, i1)
    andGate(i1, a3, output)
  }

  def andGate(a1: Wire, a2: Wire, a3: Wire, a4: Wire, output: Wire): Unit = {
    val i1, i2 = new Wire
    andGate(a1, a2, i1)
    andGate(a3, a4, i2)
   ...
   */
  def orGate(a: Bus, output: Wire): Unit = {
  ...
  def xOrGate(a1: Wire, a2: Wire, output: Wire): Unit = {
  ...
  def nOrGate(a1: Wire, a2: Wire, output: Wire): Unit = {
    val i1 = new Wire
    orGate(a1, a2, i1)
    inverter(i1, output)
  }

  def nOrGate(a: Bus, output: Wire): Unit = {
    val i1 = new Wire
    orGate(a, i1)
    inverter(i1, output)
  }
  ...
  def dFlipFlop(d: Wire, clk: Wire, nPreset: Wire, nClear: Wire, q: Wire, nq: Wire): Unit = {
    val c1 = new Wire
    val c2 = new Wire
    val c3 = new Wire
    val c4 = new Wire
  ...
  def dFlipFlop(d: Wire, clk: Wire, nClear: Wire, q: Wire, nq: Wire): Unit = dFlipFlop(d, clk, Wire.trueWire, nClear, q, nq)

  // serial in serial out
  def registerSISO(d: Wire, clk: Wire, nClear: Wire, output: Wire, size: Int): Unit = {
  ...
  def registerSIPO(d: Wire, clk: Wire, nClear: Wire, output: Bus): Unit = {
  ...
  def registerPISO(d: Bus, shift: Wire, clk: Wire, nClear: Wire, output: Wire): Unit = {
    val c1 = new Wire
    inverter(shift, c1)
   ...
   * line decoder
   */
  def oneToTwoDecoder(input: Wire, en: Wire, output1: Wire, output2: Wire): Unit = {
    val c1 = new Wire
    inverter(input, c1)
   ...
   * line decoder
   */
  def threeToEightDecoder(input: Bus, en: Wire, output: Bus): Unit = {
  ...
  /*
   * arbitary size line decoder
   */
  def decoder(input: Bus, en: Wire, output: Bus): Unit = {
  ...
  def multiplexer(d: Bus, select: Bus, output: Wire): Unit = {

    // select bus must be capable of choosing all of the input bus lines
    assert(log2(d.width) <= select.width)

    // decode the select bus
    val c1 = new Bus( scala.math.pow(2, select.width).toInt )
  ...
  def oneBitALU(a: Wire, b: Wire, select: Bus, sub: Wire, cin: Wire, less: Wire, cout: Wire, set: Wire, result: Wire): Unit = {
  ...
  def ALU(a: Bus, b: Bus, select: Bus, sub: Wire, result: Bus, zero: Wire ): Unit = {
